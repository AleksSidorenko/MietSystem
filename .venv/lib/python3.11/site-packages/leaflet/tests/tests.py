...
from .. import PLUGIN_FORMS, PLUGINS, _normalize_plugins_config
...
class PluginListingTest(SimpleTestCase):
    ...
    def test_all_resources(self):
        ...
        resources = leaflet_tags._get_all_resources_for_plugins(names, "css")
        self.assertEqual(["/static/a", "/static/b", "/static/c"], sorted(resources))
...
class TemplateTagTest(SimpleTestCase):
    ...
    def test_default_layer_in_leaflet_map(self):
        ...
        self.assertTrue(
            '"OSM", "//tile.openstreetmap.org/{z}/{x}/{y}.png"' in context["djoptions"]
        )
...
class DummyMixinModelAdmin(
    DummyAdminSettingsOverridesMixin, LeafletGeoAdminMixin, ModelAdmin
):
    pass
...
class DummyMixinStackedInline(
    DummyAdminSettingsOverridesMixin, LeafletGeoAdminMixin, StackedInline
):
...
class SettingsOverridesTest(SimpleTestCase):
    ...
    def test_spatial_extent_settings_overrides(self):
        ...
        output = widget.render("geom", "", {"id": "geom"})
        self.assertIn(
            '"extent": [[50.387507803003146, 3.812255859375], [50.523904629228625, 4.0869140625]]',
            output,
        )
