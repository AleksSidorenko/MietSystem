...
class LeafletWidget(BaseGeometryWidget):
    ...
    def get_attrs(self, name, attrs=None):
        ...
        self.settings_overrides = self.attrs.get(
        ...
        map_id_css = slugify(
            attrs.get("id", name)
        )  # id need to have - for the inline formset to replace the prefix
        ...
        attrs.update(
            ...
            settings_overrides=attrs.get(
                "settings_overrides", getattr(self, "settings_overrides", None)
            ),
            ...
            field_store_class=attrs.get(
                "field_store_class", getattr(self, "field_store_class", "L.FieldStore")
            ),
        )
        return attrs
