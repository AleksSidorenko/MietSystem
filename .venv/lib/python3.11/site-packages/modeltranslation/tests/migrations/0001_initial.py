    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        blank=True, null=True, upload_to="modeltranslation_tests"
                    ),
                ),
                (
                    "file_de",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="tests.modely"
            ),
        ),
        migrations.AddConstraint(
            model_name="modelwithconstraint",
            constraint=models.UniqueConstraint(
                fields=("title", "sub_title"), name="unique_fields"
            ),
        ),
        migrations.AddConstraint(
            model_name="modelwithconstraint",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="m2m_test_ref", to="tests.testmodel"
            ),
        ),
        migrations.AddField(
            model_name="manytomanyfieldmodel",
        ...
        migrations.AddField(
            ...
            name="through_model",
            field=models.ManyToManyField(
                through="tests.CustomThroughModel", to="tests.testmodel"
            ),
        ),
        migrations.AddField(
            model_name="manytomanyfieldmodel",
