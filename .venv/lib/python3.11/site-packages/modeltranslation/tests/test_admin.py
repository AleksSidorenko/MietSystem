...
class TranslationAdminTest(TestCase):
    ...
    def test_default_fieldsets(self):
        ...
        assert ma.get_fieldsets(self.request, self.test_obj) == [
            (None, {"fields": fields})
        ]
    ...
    def test_field_arguments(self):
        ...
        assert tuple(
            ma.get_form(self.request, self.test_obj).base_fields.keys()
        ) == tuple(fields)
    ...
    def test_model_form_widgets(self):
        ...
        for field in fields:
            assert (
                "myprop"
                in ma.get_form(self.request).base_fields.get(field).widget.attrs.keys()
            )
            assert (
                "myval"
    ...
    def test_multitable_inheritance(self):
        ...
        assert tuple(maa.get_form(self.request).base_fields.keys()) == (
            "titlea_de",
            "titlea_en",
        )
    ...
    def test_group_fieldsets(self):
        ...
        fieldsets = [
            ...
            (
                "Title",
                {"classes": ("mt-fieldset",), "fields": ["title_de", "title_en"]},
            ),
