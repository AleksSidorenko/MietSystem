...
from ._compat import build_refresh_from_db, is_hidden
...
class TranslationOptions(metaclass=FieldsAggregationMetaClass):
    ...
    def __init__(self, model: Model) -> None:
        ...
        self.related = False
        self.local_fields: dict[str, set[TranslationField]] = {
            f: set() for f in self.fields
        }
        self.all_fields: dict[str, set[TranslationField]] = {
            f: set() for f in self.fields
        }
                ...
                for cls in model.__mro__:
                    if hasattr(cls, "_meta") and cls.__dict__.get(
                        ...
                        if (
                            ...
                            or field_name not in cls_opts.local_fields
                        ):
                            raise ValueError(
...
class Translator:
    ...
    def _register_single_model(
        self, model: type[Model], opts: TranslationOptions
    ) -> None:
