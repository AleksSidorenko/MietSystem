...
_default_language: str | None = getattr(
    settings, "MODELTRANSLATION_DEFAULT_LANGUAGE", None
)
...
REQUIRED_LANGUAGES: _ListOrTuple[str] = getattr(
...
PREPOPULATE_LANGUAGE: str | None = getattr(
    settings, "MODELTRANSLATION_PREPOPULATE_LANGUAGE", None
)
...
LOADDATA_RETAIN_LOCALE: bool = getattr(
