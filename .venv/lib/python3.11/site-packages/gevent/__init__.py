...
from gevent.hub import GreenletExit, getcurrent, idle, kill, reinit, sleep, spawn_raw
...
def __dependencies_for_freezing():  # pragma: no cover
    ...
    from gevent import core, resolver_ares, resolver_thread, select
    from gevent import socket as _socket
    from gevent import subprocess, thread, threading, threadpool
