...
from _socket import EAI_NONAME, error, gaierror, herror
from gevent._compat import integer_types, text_type
from gevent._config import AresSettingMixin, config
...
from .cares import InvalidIP, channel  # pylint:disable=import-error,no-name-in-module
