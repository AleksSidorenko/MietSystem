...
class BlockElement(JsonObject, metaclass=ABCMeta):
    ...
    @classmethod
    def _get_sub_block_elements(
        cls: Type["BlockElement"],
    ) -> Iterator[Type["BlockElement"]]:
...
class DateTimePickerElement(InputInteractiveElement):
    ...
    def _validate_initial_date_time_valid(self) -> bool:
        return self.initial_date_time is None or (
            0 <= self.initial_date_time <= 9999999999
        )
...
class WorkflowButtonElement(InteractiveElement):
    ...
    def attributes(self) -> Set[str]:  # type: ignore[override]
        return super().attributes.union(
            {"text", "workflow", "style", "accessibility_label"}
        )
...
class RichTextListElement(RichTextElement):
    ...
    def attributes(self) -> Set[str]:  # type: ignore[override]
        return super().attributes.union(
            {"elements", "style", "indent", "offset", "border"}
        )
