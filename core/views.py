...
#
#     # НОВОЕ: Убедитесь, что hit_rate_history - это всегда JSON-строка
#     hit_rate_history_list = data['redis'].get('hit_rate_history', [])
#     data['redis']['hit_rate_history'] = json.dumps(hit_rate_history_list)
#
#     context = {
#         "data": data,
